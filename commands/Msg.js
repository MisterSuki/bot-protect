...
module.exports.run = async (bot, message, args) => { //exportando o comando!
    if(!message.member.permissions.has("GÉRER_MESSAGES")) return message.channel.send("tu ne peux pas faire ça!"); //se a pessoa não tiver permissões retornar e vai mandar a mensagem
