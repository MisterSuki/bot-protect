...
if(process.env.owner ===message.author.id || db.get(`ownermd.${message.author.id}`) === true || db.get(`${message.guild.id}.${message.author.id}.wlmd`) === true) {
    ...
    .addField(`\`${prefix}screenshot <url>\``, "veuillez mettre un URL pour que le bot puissent faire une capture d'écran")
    .addField(`\`${prefix}supreme <texte>\``, "veuillez écrire un texte pour que le bot puissent faire un Screenshots avec votre texte ")
...
.addField(`\`${prefix}invites<@membres/id>\``,"vois les invites des membres")
...
.addField(`\`${prefix}membercount\``, "vois tous les membres")
.addField(`\`${prefix}userID<@membres/id>\``,"donne l'ID du membre")
